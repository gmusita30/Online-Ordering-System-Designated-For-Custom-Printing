...
<body>
    ...
    if($resultCheck > 0){
        while ($row = mysqli_fetch_assoc($search_result)){
            ...
            if ($row['rate'] == 0){
                ...
                $rate = number_format($row['rate']/$ratings);
            }

            if ($i % 4 == 0){
                $table .= '<tr><td><a class = "tableRow" href = "product.php?id= '. $id .'&productName= '. $pName .'">
                <img src="./admin/inventory/Images/'. $image .'" style = "display:block; margin-left: auto; margin-right:auto; width: 200px; height: 200px;">
                <h2>'. $pName .'</h2>
    ...
    <img src= "Images/tree.png" style = "position:fixed; width: 200px; height: 100px; margin-left: -15px; margin-top: 560px;">
    <img src= "Images/tree.png" style = "position:fixed; width: 200px; height: 100px; margin-left: 1320px; margin-top: 560px;">
    </div>
<div id = "table-scroller1">
<div class = "footer" style = "margin-top: 603px; margin-left: -10px; padding-left: 20px;">
